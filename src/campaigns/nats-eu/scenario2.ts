      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'A carrier radiated at a bird with no tasking breaks flight rules, and an HPA enabled with no drive amplifies its own noise into the feed',
              'The receiver cannot lock while the HPA is disabled',
              'The link budget needs the HPA output power',
              'It does not matter - the interlocks handle it',
            ],
            correctIndex: 0,
            explanation: 'Cold and confirmed. The transmit half of the licence is a later card; today the station only listens, and it has to be seen to only listen.',
            pointPenalty: 5,
          },
          mustMaintain: false,
        },
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              ...
              'The GPSDO reference',
              'Rounding in the survey',
              'The BUC, even when muted',
            ],
            correctIndex: 0,
            explanation:
      ...
      conditions: [
        {
          ...
          params: {
            ...
            options: [
              '180.9 dB - about 9.5 dB more, so C/N at AOS is roughly 1.5 dB, not 11',
              '176.1 dB - about 4.7 dB more',
              '171.4 dB - range does not enter free-space loss',
              '190.4 dB - three times the range is 19 dB',
            ],
            correctIndex: 0,
            explanation:
              'Path loss goes with range squared: 20 log10(2270 / 761) = 9.5 dB. That single number is why the acceptance window is the middle of the pass and why nobody decodes at the horizon.',
            pointPenalty: 5,
          },
          mustMaintain: false,
        },
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              ...
              '14:03:10 at AOS, before the link degrades',
              '14:10:18 at LOS, once the pass is complete',
              'Any time the modem shows lock',
            ],
            correctIndex: 0,
            explanation: 'Culmination is the shortest range of the pass, so it is the best C/N the station will see on this geometry and the number the card is written against.',
            pointPenalty: 5,
          },
          mustMaintain: false,
        },
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'Same elevation, same slant range, same path loss and same sky noise - the curve is symmetric about culmination',
              'The AGC has settled by the setting leg',
              'Doppler is zero on the setting leg',
              'Coincidence - the two readings are independent',
            ],
            correctIndex: 0,
            explanation: 'C/N on a pass is a function of geometry. Read one leg and you have predicted the other; a difference between them is a fault, not physics.',
            pointPenalty: 5,
          },
          mustMaintain: false,
        },
      ...
      conditions: [
        {
          ...
          params: {
            ...
            options: [
              'Predicted 11.0 dB; measured 10.9 dB at 28 deg; margin over the 6 dB threshold 4.9 dB; ~7 dB at 15 deg both legs',
              'Measured 10.9 dB',
              'Link accepted',
              'Predicted 11.0 dB; measurement not required',
            ],
            correctIndex: 0,
            explanation: 'Prediction, measurement, margin, and the two shoulder readings that prove the curve. A card Rotterdam can check tomorrow against a different pass.',
            pointPenalty: 5,
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'A second bird on a second geometry against the same model: if the model predicts this one too, the acceptance number was not luck',
              'Rotterdam pays per pass',
              'The receiver needs the exercise',
              'No reason - it is a stretch goal only',
            ],
            correctIndex: 0,
