...
export const natsEuScenario1Data: ScenarioData = {
  ...
  objectives: [
    ...
    },
    {
      ...
      description: 'LNB LO at 13100 MHz. Work out where the 11686 MHz SAR-1 imagery downlink lands at IF before you tune anything to it.',
      groundStation: 'GW-01',
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: ['1414 MHz (LO minus RF - high-side LO)', '24786 MHz (LO plus RF)', '11686 MHz (the LNB passes RF through)', '1370 MHz (that is the SAR-2 carrier)'],
            correctIndex: 0,
            explanation:
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'Doppler walks the beacon about 550 kHz end to end; it would leave the screen',
              'The analyzer cannot resolve a CW line below 1 MHz span',
              'The beacon is 36 MHz wide',
              'A narrow span raises the displayed noise floor',
            ],
            correctIndex: 0,
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: ['14:03, azimuth 000 - due north, peaking at 28 degrees to the west', '14:07, azimuth 294', '14:10, azimuth 224', '14:18, azimuth 130 - that is SAR-2'],
            correctIndex: 0,
            explanation: 'Rises due north at 14:03, culminates at 28 degrees in the west-north-west at 14:06:45, sets south-west at 14:10. Under nine minutes above the mask.',
            pointPenalty: 5,
          },
          mustMaintain: false,
        },
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'Approach raises the RF; the high-side LO inverts the spectrum, so a higher RF lands lower at IF',
              'The beacon transmitter drifts low when the spacecraft is cold',
              'The LNB LO pulled low under load',
              'The analyzer reference level was set too high',
            ],
            correctIndex: 0,
            explanation:
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'Imagery 1370 MHz, beacon 1397 MHz; AOS 14:18 from azimuth 130, seven minutes after SAR-1 sets',
              'Imagery 1414 MHz, beacon 1389 MHz; same plan as SAR-1',
              'Imagery 1430 MHz, beacon 1403 MHz; AOS 14:18',
              'Imagery 1370 MHz, beacon 1397 MHz; AOS 14:03 tomorrow',
            ],
            correctIndex: 0,
            explanation: '13100 - 11730 = 1370 and 13100 - 11703 = 1397. Different bird, different carrier, same arithmetic. You have the gap between LOS and AOS to be ready.',
            pointPenalty: 5,
          },
          mustMaintain: false,
        },
      ...
      conditions: [
        {
          ...
          params: {
            ...
            options: [
              'Decoded, C/N >= 8 dB held through culmination, peak ~11 dB at 28 degrees, no anomalies',
              'Decoded, no measurements taken',
              'Missed - stale ephemeris',
