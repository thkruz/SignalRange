/**
 * Minimal ANSI logger for the plugin CLI. Self-contained so the CLI never pulls
 * in bundler-side reporters.
 */
const STYLE = {
  gray: '\x1b[90m',
  cyan: '\x1b[36m',
...
export const log = {
  ...
  red: (msg: string): string => paint('red', msg),
  yellow: (msg: string): string => paint('yellow', msg),
};
