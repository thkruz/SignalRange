        ...
        },
        {
          ...
          params: {
            ...
            options: [
              ...
              'The two sites share one receiver, so only one contact can decode at a time.',
            ],
            correctIndex: 0,
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'It must be allocated like the others - priority 2 is inside the required set, so the plan stays UNALLOCATED without it',
              'It can be left unassigned; only priority 1 is mandatory',
              'It goes to Galway automatically as the lower priority',
              'Priority only sets the order the console lists contacts in',
            ],
            correctIndex: 0,
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              ...
              'Longer passes, because the two horizons are added together.',
            ],
            correctIndex: 0,
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'Southbound pass with the ground track west of Ireland: Shetland is further north, so the bird crosses its horizon first, and further east of the track, so it never climbs as high',
              'Shetland runs a lower elevation mask than Galway',
              'The two sites are propagating different element sets',
              'Shetland is at higher altitude, which extends its horizon',
            ],
            correctIndex: 0,
            explanation:
              'Where you stand decides the pass. A sun-synchronous bird at 97 degrees inclination runs nearly pole to pole, so a site at 60 north sees more of its orbits than one at 53: more passes per day, and different ones. The SAR-2 pass at 14:19 goes 86 degrees overhead here and 25 over Galway.',
            pointPenalty: 5,
          },
          mustMaintain: false,
        },
      ...
      conditions: [
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              'Slant range: 860 km from Shetland against 761 km from Galway is about 1 dB more path loss, and a lower elevation adds a little more atmosphere',
              'The Shetland LNB runs warmer, so its noise figure is worse',
              'Shetland is further from the satellite because it is further north',
              'The remote link adds a decibel of loss between the sites',
            ],
            correctIndex: 0,
            explanation:
        ...
        },
        {
          ...
          params: {
            ...
            options: [
              ...
              "Galway's, because a lower pass keeps the bird in the beam longer",
              'The same - C/N depends on the bird, not the site',
              "Shetland's, by about 1 dB, the same as the SAR-1 difference",
            ],
            correctIndex: 0,
            explanation:
      ...
      conditions: [
        {
          ...
          params: {
            ...
            options: [
              'Which site flew each contact and what it measured: SH-02 remote, peak 9.8 dB at 24 degrees; GW-01, peak 11 dB at 28 degrees - both decoded',
              'That the plan validated',
              'That Galway had the better pass, so Shetland was not needed',
              'The NORAD ids and nothing else; measurements go to Rotterdam',
            ],
            correctIndex: 0,
            explanation: 'Site, operator, number. The first remote pass is a baseline for every remote pass after it. Day one as a network: nothing dropped.',
            pointPenalty: 5,
