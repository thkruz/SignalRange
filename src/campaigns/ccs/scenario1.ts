      ...
      conditions: [
        {
          ...
          params: {
            ...
            options: [
              ...
              'Transmit below the target power to protect the HPA from overdrive',
              'Point the monitor antenna away from the target while the jam is keyed',
              'Key the backup transmit string before the primary string has tripped',
            ],
            correctIndex: 0,
      ...
      conditions: [
        {
          ...
          params: {
            ...
            options: [
              ...
              'No - the jam overlaps the edge of the protected band',
              'Only if the HPA back-off is increased by a few dB',
              'Only if the monitor antenna is stowed for the jam',
            ],
            correctIndex: 0,
